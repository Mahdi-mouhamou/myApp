...
class PinosController extends \TCG\Voyager\Http\Controllers\VoyagerBaseController
{
    ...
    public function show(Request $request, $id)
    {
        ...
        return Voyager::view($view, compact('dataType', 'dataTypeContent', 'isModelTranslatable', 'isSoftDeleted', 'post'));
    }
    ...
    public function updateData(Request $request)
    {
        ...
        $produit->typeArticle = $request->typeArticle;
    ...
    public function diagram () {
		...
		$categories = Category::all();
        $cpt=Category::all()->count();
        $produit =Produit::all();

		// La vue "diagram" avec les catégories
		return view("diagram", compact('categories','cpt'));
}
    public function ind(){
        $post= Poste::all();

        $cmt=DB::table('comments')
        ->join('postes','postes.id','=','comments.poste_id')
        ->select('Post')
        ->get()
        ;
